        ...
        if ( ($name =~ /^ENS/ or
            ...
            if (scalar @ens_query > 1) {
                ...
                foreach my $eid (@ens_query) {
                    ...
                    my $href = "http://www.sanger.ac.uk/cgi-bin/PostGenomics/S_pombe/YOGY/yogy-search.pl?gene=${eid}&species=${species}&wild=${wild_card}&go_term=${go_term}&go_final=${go_final}";
