...
# Removed row <tr><td>" ."<a href=$kog_href target=$gBlank title='KOGs' " . "style='$gStyle'>KOGs</a></td><td>$img1</td></tr>" .
    push(@namerows,
         td(["<em>Datasets</em>",
             "<table> <tr><td><a href=$inp_href target=$gBlank title='Inparanoid' " .
